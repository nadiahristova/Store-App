...
namespace StoreApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<InventoryManagerContext>(opts => opts.UseSqlServer(Configuration["ConnectionString:InventoryDB"]));
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseMvc(routes =>
            {
                routes.MapRoute(
                    name: "default",
                    template: "{controller=BookInventory}/{action=Index}/{id?}");
            });
        }
    }
}
